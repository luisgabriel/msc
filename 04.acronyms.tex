...
\acro{clbg}[CLBG]{The Computer Language Benchmarks Game}
\acro{wai}[WAI]{Haskell Web Application Interface}
\acro{rapl}[RAPL]{Running Average Power Limit}
\acro{msr}[MSR]{Machine-Specific Register}
\acro{caf}[CAF]{Constant Applicative Form}
\end{acronym}
